...
```
5. Las pruebas necesarias para verificar que funcionen correctamente
...
- PowerBonusScore
    ...
    public void PowerBonusShouldBeLessThanFiveHundreed(){
     ...
     ```
    ademas de esto, al ejecutar las pruebas:
    
    ![image](https://github.com/GabrielSilva2111/Lab4/assets/110953563/e988c64b-982f-457e-b857-e1b379bd0dbb)

   Podemos observar que las pasan sadisfactoriamente



   

7. por Último guardamos los cambios con el comando git Push
